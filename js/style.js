...
$(document).ready(function () {
    ...
    //      // $().myfunction();
    //      isSmall = 1;
    //      $(".title").css({'transition': '0.2s','position':'fixed', 'width': '100%', 'box-shadow':'none', 'text-shadow':'rgb(59, 59, 59) 2px 2px'})
    //      .delay(100)
    //      .queue( function(next){ 
    //          $(".title").css({'transition': '0.1s','height':'70px', 'line-height':'70px', 'font-size':'3em'});
    //           $(".header").css({'height':'108px'});
